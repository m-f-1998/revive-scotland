...
export const PRAYER_TYPES: { value: string; label: string } [ ] = [
...
@Component ( {
  selector: "app-prayers-editor",
  imports: [ IconComponent, FormsModule ],
  templateUrl: "./prayers-editor.component.html",
  changeDetection: ChangeDetectionStrategy.OnPush
} )
export class PrayersEditorComponent {
  @Input ( ) public prayers: Prayer [ ] = [ ]
  @Input ( ) public saving = false
  public readonly prayersChange = output<Prayer [ ]> ( )
  ...
  public removePrayer ( index: number ): void {
    const p = this.prayers.filter ( ( _, i ) => i !== index )
    this.prayersChange.emit ( p )
  ...
  public updatePrayer ( index: number, field: keyof Prayer, value: string ): void {
    const p = this.prayers.map ( ( item, i ) => i === index ? { ...item, [ field ]: value } : item )
    this.prayersChange.emit ( p )
  }
